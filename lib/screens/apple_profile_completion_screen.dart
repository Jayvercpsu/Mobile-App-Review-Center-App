...
class AppleProfileCompletionScreen extends StatefulWidget {
  const AppleProfileCompletionScreen({
    super.key,
    this.prefillName,
    this.prefillEmail,
  });
  ...
  @override
  State<AppleProfileCompletionScreen> createState() =>
      _AppleProfileCompletionScreenState();
}

class _AppleProfileCompletionScreenState
    extends State<AppleProfileCompletionScreen> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>(
    debugLabel: 'apple_profile_completion_form',
  );
  ...
  Future<void> _submit() async {
    ...
    final AppleLoginResult result = await context
        .read<AppState>()
        .loginWithApple(
